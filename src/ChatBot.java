public class ChatBot {
    ...
    // method that prints favorite animal
    public void favAnimal(String favAnimal) {
        System.out.println("Your favorite animal is a " + favAnimal + ", that's so cool!");
   }
    ...
    //method that subtracts and returns the difference of the 2 num
    public int subNumbers(int largeNum, int smallNum){
